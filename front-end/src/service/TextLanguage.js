  ...
  return linguagem == "pt"
    ? {
      ...
      barraProgressaoProposta: {
        ...
        mensagemFeedbackCcsFaltando: "A porcentagem das CCs deve ser 100% para cada tabela de custos!",
      ...
      escopos: {
        tour: {
          ...
          tour2: "Aqui ficam os escopos criados automaticamente, em cada escopo é possível abrir novamente para edição. É criado um escopo para cada projeto que você abre e não finaliza",
      ...
      home: {
        tourAjuda: {
          ...
          modoVisualizacao: "Nestes botões você consegue acessar o modal de ordenação e também consegue mudar o modo de visualização das suas demandas.",
          ...
          botaoChat: "Clicando neste botão você consegue abrir o chat da demanda."
        },
        demandaCriadaComSucesso: "Demanda criada com sucesso!",
        minhasDemandas: "Minhas Demandas",
        meuDepartamento: "Meu Departamento",
      ...
      homeGerencia: {
        ...
        toursDemandas: {
          ...
          tour3: "Aqui fica o filtro que abre uma sidebar, permitindo a filtragem por campos e também a ordenação",
          ...
          tour6: "Nesta parte ficam as demandas, podendo clicar em uma demanda para ver mais detalhes",
          ...
          tour10: "Aqui consegue observar o motivo pelo qual foi recusado ou o motivo da edição.",
          tour11: "Clicando neste botão você consegue abrir o chat da demanda."
        },
        toursCriarPropostas: {
    ...
    : linguagem == "en"
      ? {
        ...
        barraProgressaoProposta: {
          ...
          botaoCriar: "Create",
          botaoProximo: "Next",
          mensagemFeedbackCamposObrigatorios: "You must fill in all the required fields!",
          mensagemFeedbackCcsFaltando: "The CCs' percentage must be 100% for each costs table!",
        ...
        DetalhesDemanda: {
          facaAlgumaAlteracaoParaPoderSalvar: "Do some changes to be able to save!",
        ...
        modalConfirmacao: {
          mensagensModal: {
            ...
            tirarPropostaDePauta: "Do you really want to remove the proposal from the agenda?",
        ...
        notificacaoComponente: {
          ...
          vcRecebeuMensagem: "You have received a message from a demand with PPM",
          por: "by",
          propostaDeDemanda: "A proposal was created from a demand with sequential number",
          noForum: "at the forum",
          naDG: "at the DG",
          entrouEm: "got in",
          businessCase: "Business Case",
          oAnalistaResposnavel: "The Responsible Analyst",
          mudouStatusDemanda: "changed the status of demand with sequential number",
          para: "to",
          assessment: "Assessment",
          cancelled: "Cancelled",
          done: "Done",
        ...
        chat: {
          tour: {
            tour1: "In this input you can search for chats by username and by the sequential number of the demand.",
        ...
        homeGerencia: {
          ...
          toursDemandas: {
            ...
            tour3: "Here is the filter, where you can filter by: Requestor, Responsible Manager, Forum, Department, Size and number.",
          ...
          toursPropostas: {
            ...
            tour2: "By clicking here you can open the chat with the demand requestor.",
            tour3: "By clicking here you can see the proposal's history of changes.",
          },
          toursPautas: {
            tour1: "In this part are the agendas, where you can click on an agenda to see more details.",
          ...
          pesquisarPorNumeroSequencialOuProposta: "Search by sequential number or proposal...",
          pesquisar: "Search",
        ...
        modalAddPropostaPauta: {
          ...
          essaPropostaJaSeEncontraEmUmaPauta: "This proposal is already in an agenda!",
        ...
        criarPauta: {
          ...
          naoHaPropostasParaSeremAdicionadas: "There are no proposals to be added!",
          publicada: "Published",
      ...
      : linguagem == "ch"
        ...
        detalhesProposta: {
          ...
          detalhesDemandaPagina: {
            tour: {
              tour1: "这是需求详细信息页面。在这里，您可以查看所选需求的所有详细信息。",
              tour2: "通过单击此处，您可以将此需求下载为PDF格式。",
              tour3: "通过单击此铅笔，您可以编辑此需求。",
            },
          },
          ...
          escopos: {
            tour: {
              tour1: "这是搜索栏，在这里您可以按标题搜索。",
              tour2: "这是自动生成的范围，在每个范围中，都可以再次打开以进行编辑。每个您打开并未完成的项目都会创建一个范围。",
              tour3: "在这个区域，您可以看到表格填写的百分比。",
              tour4: "通过单击垃圾桶，您可以删除范围。",
            },
            pesquisarPorTitulo: "按标题搜索...",
          ...
          home: {
            tourAjuda: {
              barraDePesquisa: "这是搜索栏，在这里您可以按标题搜索。",
              iconeOredenar: "在这个图标中，您可以按标题（A-Z或Z-A）、分数（从高到低或从低到高）和日期（从新到旧或从旧到新）对需求进行排序。",
              botaoFiltrar: "在这个按钮中，您可以按需求状态过滤需求。",
              modoVisualizacao: "在这里，您可以更改查看需求的方式。您可以选择在列表或卡片的形式中查看需求。",
              criarNovaDemanda: "在这里，您可以开始创建新需求。",
              areaDemanda: "在这个区域中，您可以看到您的需求。您可以单击需求以查看更多详细信息。",
              statusDemanda: "在这里，您可以看到需求的状态。",
              botaoMotivo: "在这里，您可以查看需求的状态。",
            },
            demandaCriadaComSucesso: "需求创建成功！",
          ...
          homeGerencia: {
            ...
            toursDemandas: {
              ...
              tour4: "在这里，您可以将需求导出为电子表格格式。",
              tour5: "在这里，您可以开始创建新需求。",
              tour6: "在这个区域中，您可以看到您的需求。您可以单击需求以查看更多详细信息。",
              tour7: "在这里，您可以查看需求的历史记录。",
              tour8: "在这里，您可以看到需求的状态。",
              tour9: "在这里，您可以更改查看需求的方式。您可以选择在列表或卡片的形式中查看需求。",
            },
            toursCriarPropostas: {
              tour1: "在这个区域中，您可以看到需求。您可以单击需求以查看更多详细信息。",
              tour2: "在这里，您可以看到需求的状态。",
              tour3: "在这里，您可以查看需求的历史记录。",
            },
            toursPropostas: {
              tour1: "在这个区域中，您可以看到提案。您可以单击提案以查看更多详细信息。",
              tour2: "在这里，您可以与需求请求者聊天。",
              tour3: "在这里，您可以查看提案的历史记录。",
            },
            toursPautas: {
              tour1: "在这个区域中，您可以看到会议记录。您可以单击会议记录以查看更多详细信息。",
              tour2: "在这里，您可以删除会议记录。",
            },
            toursAtas: {
              tour1: "在这个区域中，您可以看到会议记录。您可以单击会议记录以查看更多详细信息。",
        ...
        : linguagem == "es"
          ? {
            ...
            DetalhesDemanda: {
              real: "Real",
              facaAlgumaAlteracaoParaPoderSalvar: "¡Haga algún cambio para poder guardar!",
            ...
            formularioAnexosDemanda: {
              arrasteSolteParaAdicionarUmArquivo: "Arrastre y suelte para agregar un archivo",
            ...
            notificacaoComponente: {
              ...
              por: "por",
              propostaDeDemanda: "Se creó una propuesta a partir de una demanda con número secuencial",
              noForum: "en el foro",
              naDG: "en el DG",
              entrouEm: "entró",
              businessCase: "Business Case",
              oAnalistaResposnavel: "El analista responsable",
              mudouStatusDemanda: "cambió el estado de la demanda con número secuencial",
              para: "para",
              assessment: "Assessment",
              cancelled: "Cancelled",
              done: "Done",
            ...
            chat: {
              tour: {
                tour1: "En este input puede buscar los chats por nombre de usuario y por número secuencial de la demanda.",
                tour2: "Aquí se encuentran los chats abiertos, teniendo el nombre de usuario, el número secuencial de la demanda y de qué demanda pertenece.",
                tour3: "En este botón puede elegir entre minimizar el chat o cerrar la conversación (cerrando el chat).",
                tour4: "Aquí puede escribir lo que desea enviar, pudiendo también adjuntar algún archivo.",
              },
              pesquisarPorNome: "Pesquisar por usuário...",
              usuarioTour: {
                tour: "Tour",
            ...
            detalhesDemandaPagina: {
              tour: {
                tour1: "Esta es la página de detalles de la demanda. Aquí puede ver todos los detalles de la demanda seleccionada.",
                tour2: "Haciendo clic aquí, puede descargar en PDF esta demanda.",
                tour3: "Haciendo clic en este lápiz, puede editar las informaciones.",
              },
            },
            detalhesPauta: {
              feedbacks: {
            ...
            escopos: {
              tour: {
                tour1: "Aquí está la barra de búsqueda, donde puede buscar por un título.",
                tour2: "Aquí están los alcances creados automáticamente, en cada alcance es posible abrir nuevamente para edición. Se crea un alcance para cada proyecto que abre y no finaliza.",
                tour3: "En esta área puede ver el porcentaje de llenado del formulario.",
                tour4: "Haciendo clic en la papelera de reciclaje, puede eliminar el alcance.",
              },
            ...
            home: {
              tourAjuda: {
                barraDePesquisa: "Aquí está la barra de búsqueda, donde puede buscar por un título.",
                iconeOredenar: "En este ícono puede ordenar las demandas por título (A-Z o Z-A), Score (Mayor a menor o menor a mayor) y por fecha (Más nueva a más vieja o más vieja a más nueva).",
                botaoFiltrar: "En este botón puede filtrar sus demandas por sus estados.",
                modoVisualizacao: "En esta parte puede cambiar el modo de visualización de sus demandas. Puede elegir entre visualizar las demandas en forma de lista o en forma de tarjetas.",
                criarNovaDemanda: "Aquí puede iniciar la creación de una nueva demanda.",
                areaDemanda: "En esta área puede observar sus demandas. Puede hacer clic en una demanda para ver sus detalles.",
                statusDemanda: "En esta área puede observar el estado actual de la demanda.",
                botaoMotivo: "Aquí puede observar el motivo por el cual fue rechazada o el motivo de la edición.",
              },
              ...
              pesquisarPorTitulo: "Buscar por título...",
              pesquisarPorTituloOuNumero: "Buscar por título o número secuencial...",
              pesquisar: "Buscar",
            ...
            homeGerencia: {
              ...
              toursDemandas: {
                ...
                tour3: "Aquí está el filtro, donde puede filtrar sus demandas por Solicitante, Gerente Responsable, Fórum, Departamento, Tamaño y Número.",
                tour4: "Aquí está el lugar para exportar sus demandas en formato de planilla.",
                tour5: "Aquí puede iniciar el proceso de creación de una nueva demanda.",
                tour6: "En esta área puede observar sus demandas. Puede hacer clic en una demanda para ver sus detalles.",
                tour7: "Haciendo clic aquí puede ver el historial de cambios de la demanda.",
                tour8: "En esta área puede ver el estado de la demanda.",
                tour9: "Pulsando aquí puedes cambiar el modo de visualización a mesa o cartas.",
              },
              toursCriarPropostas: {
                tour1: "En esta parte está la demanda, puede hacer clic en una demanda para ver más detalles y/o crear una propuesta.",
                tour2: "En esta área puede ver el estado de la demanda.",
                tour3: "Haciendo clic aquí puede ver el historial de cambios de la demanda.",
              },
              toursPropostas: {
                tour1: "Aquí está la propuesta, puede hacer clic en una propuesta para ver más detalles.",
                tour2: "Haciendo clic aquí puede abrir el chat con el solicitante de la demanda.",
                tour3: "Haciendo clic aquí puede ver el historial de cambios de la propuesta.",
              },
              toursPautas: {
                tour1: "Aquí está la pauta, puede hacer clic en una pauta para ver más detalles.",
                tour2: "Haciendo clic aquí puede eliminar la pauta.",
              },
              toursAtas: {
                tour1: "Aquí está la ata, puede hacer clic en una ata para ver más detalles.",
              },
              feedback: {
                ...
                feedback17: "¡No hay datos para exportar!",
              },
              demandas: "Demandas",
              ...
              pesquisarPorNumeroSequencialOuProposta: "Buscar por número secuencial o propuesta...",
              pesquisar: "Buscar",
            ...
            notFound: {
              ...
              desculpePaginaNaoEncontrada: "¡Lo sentimos, la página solicitada no se encontró!",
              porfavorVolteParaPaginaPrincipal: "Por favor, vuelva a la página principal.",
              voltar: "Volver",
            },
            notificacao: {
              notificacaoMArcadasComoNaoLidasComSucesso: "Notificaciones marcadas como no leídas con éxito!",
              notificacaoMArcadasComoLidasComSucesso: "Notificaciones marcadas como leídas con éxito!",
              notificacaoExcluidasComSucesso: "Notificaciones eliminadas con éxito!",
              notificacoes: "Notificaciones",
              deletar: "Eliminar",
