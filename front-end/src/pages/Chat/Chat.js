            ...
            <Box className='p-2'>
                ...
                <Box className='w-full flex justify-center items-center'>
                    <Box className='flex justify-evenly items-center rounded border mt-4' sx={{ width: '100rem', height: '50rem' }}>
                        ...
                        {
                            !chatAberto ?
                                <Box className='flex flex-col items-center justify-center rounded border' sx={{ width: '75%', height: '95%', cursor: 'default' }}>
                                    <img src={logoWeg} alt="chat" />
                                    <Typography fontSize={FontConfig.title} color={'text.secondary'} sx={{ fontWeight: '600' }}>Selecione alguma conversa</Typography>
                                </Box>
                                :
                                <Box className='flex flex-col items-center justify-between rounded border' sx={{ width: '75%', height: '95%' }}>
                                    <Box className='flex justify-between items-center w-full' sx={{ backgroundColor: 'primary.main', height: '10%' }}>
                                        <Box className="flex items-center">
                                            ...
                                            <Box className='flex flex-col ml-3' sx={{ cursor: 'default', color: '#FFFF' }}>
                                        ...
                                        <Box className="rounded-3xl p-0.5 mr-7 delay-120 hover:scale-110 duration-300" sx={{ cursor: 'pointer', color: '#FFFF' }}>
                                    ...
                                    <Box className='flex border px-3 py-1 m-4 rounded items-center' sx={{ backgroundColor: 'input.main', width: "90%", height: '6.5%' }}>
                                        ...
                                        <Box className='flex gap-2 delay-120 hover:scale-110 duration-300'>
                                            <AttachFileOutlinedIcon sx={{ color: 'primary.main', cursor: 'pointer' }} />
                                        </Box>
                                        <Divider orientation="vertical" sx={{ borderColor: 'primary.main', margin: '0 10px 0 10px' }} />
                                        <Box className='flex gap-2 delay-120 hover:scale-110 duration-300'>
                                            <SendOutlinedIcon sx={{ color: 'primary.main', cursor: 'pointer' }} />
                                        </Box>
                                    </Box>
                                </Box>
                        }
