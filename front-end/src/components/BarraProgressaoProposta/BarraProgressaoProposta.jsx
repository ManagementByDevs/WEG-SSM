...
const BarraProgressaoProposta = (props) => {
    ...
    return (
        <>
            ...
            {/* {activeStep == 0 && <DetalhesDemanda dados={paginaDados} setDados={setPaginaDados} />}
            ...
            {activeStep == 3 && <FormularioConfirmacaoDemanda dados={paginaDados} beneficios={paginaBeneficios} arquivos={paginaArquivos} />} */}
