...
import { List, Divider, ListItemIcon, ListItemText, ListItemButton, Collapse, Checkbox, FormControlLabel, Box } from "@mui/material";
...
export default function ItemOrdenacao(props) {
  ...
  /** Função para mudar o valor do checkbox de ordenação por PPM "Decrescente" */
  const mudarCheck7 = () => {
    props.setOrdenacaoPPM([!props.ordenacaoPPM[0], false]);
  };

  /** Função para mudar o valor do checkbox de ordenação por PPM "Crescente" */
  const mudarCheck8 = () => {
    props.setOrdenacaoPPM([false, !props.ordenacaoPPM[1]]);
  };
