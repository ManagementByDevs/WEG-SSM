  ...
  return (
    <Box
      ...
      sx={{
        ...
        borderTop: "7px solid #00579D",
        borderRadius: "5px",
        cursor: "pointer",
      }}
      className={`items-center h-30 text-justify drop-shadow-lg`}
    >
      <Box className="flex flex-col justify-between" sx={{height: '100%'}}>
        <Box>
        ...
        <Box className={`flex justify-end items-end`} sx={{ marginTop: ".5%" }}>
